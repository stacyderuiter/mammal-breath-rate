...
What about doing something similar for the intercepts (or marginal means)? This is not quite a correct approach - not ready to present.

```{r}
int_comparison <- emmeans(breath_model, 
         pairwise ~ habitat,
         var = "log_Mb")

int_comparison <- as.data.frame(int_comparison$contrasts)
int_comparison
```
